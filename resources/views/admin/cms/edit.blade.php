        ...
        <section class="col-lg-12 ">
          ...
          <div class="card">            
            <div class="card-body">              
               ...
               <!-- form start --> 
  {!! Form::open(['action' => ['Admin\CmsController@update', $cms->id], 'method' => 'PUT', 'enctype' => 'multipart/form-data'])  !!}
  <!-- CSRF TOKEN -->
    {{ csrf_field() }}
  <div class="row">
     <div class="col-md-8">
      <div class="form-group col-">
          ...
          {{Form::text('cms_title', $cms->cms_title, ['class' => 'form-control', 'placeholder' => 'Title' ])}}
      ...
      <div class="form-group">
          ...
          {{Form::textarea('cms_body', $cms->cms_body, ['id' => 'article-ckeditor', 'class' => 'form-control', 'placeholder' => 'Body Text'])}}
      ...
      <div class="form-group">
        ...
        {{Form::text('breadcrumb',  $cms->cms_breadcrumb, ['class' => 'form-control', 'placeholder' => 'Breadcrumb'])}}
        <span class="help"> 
      ...
      <div class="form-group">
        ...
        {{Form::text('cms_meta_data',  $cms->cms_meta_data, ['class' => 'form-control', 'placeholder' => 'Meta Data'])}}
      ...
      <div class="col-md-4">
        ...
        <div class="form-group">
          ...
          {{Form::text('cms_slug', $cms->cms_slug, ['class' => 'form-control', 'placeholder' => 'Slug' ])}}
        </div>
         <div class="form-group">
              {{Form::label('meta_title', 'Meta Title')}}
              {{Form::text('cms_meta_title',  $cms->cms_meta_title, ['class' => 'form-control', 'placeholder' => 'Meta Title' ])}}
          </div>
          <div class="form-group">
              {{Form::label('meta_key', 'Meta Key')}}
              {{Form::text('cms_meta_key',  $cms->cms_meta_key, ['class' => 'form-control', 'placeholder' => 'Meta Key is separated by comma'])}}
          </div>
          <div class="form-group">
